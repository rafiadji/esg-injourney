...
urlpatterns = [
    ...
    path("get_location/<int:pic_id>", views.get_location),
    path("get_location/<int:pic_id>/<int:grp_id>", views.get_location),
    ...
    path("location_form/<str:mode>/", views.location_form),
    path("location_form/<str:mode>/<int:id>", views.location_form),
